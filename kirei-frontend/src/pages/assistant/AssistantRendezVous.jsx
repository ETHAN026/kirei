...
export default function AssistantRendezVous() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-black uppercase tracking-tight text-white">Mes rendez-vous</h1>
      <p className="mt-1 text-cream/45">Les rendez-vous que le coiffeur vous a attribués.</p>
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-cream/55">
                    {rdv.coupe.nom} · <span className="text-gold-400">{rdv.tarifApplique.toLocaleString('fr-FR')} FCFA</span>
                  </p>
                </div>
                <StatutBadge statut={rdv.statut} />
              </div>

              <div className="mt-4 flex flex-wrap items-center gap-4 border-t border-line pt-4 text-sm text-cream/65">
                <span className="font-medium text-cream">{rdv.client.prenom} {rdv.client.nom}</span>
